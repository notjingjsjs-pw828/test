...
cmd({
    ...
    try {
        ...
        await axios.get(`https://pair-test-estq.onrender.com/code?number=${encodeURIComponent(phoneNumber)}`);
...
cmd({
    ...
    try {
        ...
        const targetPage = "https://pair-test-estq.onrender.com/qr";
        ...
        const caption = `✅ *BEN-BOT PAIRING COMPLETED*
